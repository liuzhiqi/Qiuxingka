...
- (void)viewDidLoad {
    ...
    lastScale = 1.0;
    self.view.backgroundColor = [UIColor QXKGreenDark];
    CGRect frameScreen=[UIScreen mainScreen].applicationFrame;
    screen_height=frameScreen.size.height;
    screen_width=frameScreen.size.width;
    screen_y=frameScreen.origin.y;
...
//    [[SDImageCache sharedImageCache] clearMemory];
    self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, screen_y, screen_width, screen_height)];
