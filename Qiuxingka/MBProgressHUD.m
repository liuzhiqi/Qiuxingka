...
+(void )showHubWithTitle:(NSString*) title type:(NSInteger) type deleController:(UIViewController*)delegateCTL{
    
    MBProgressHUD *HUD = [[MBProgressHUD alloc] initWithView:delegateCTL.view];
    [delegateCTL.view addSubview:HUD];
